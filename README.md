...
| License | [MIT](LICENSE) |
| Latest release | [v0.1.29](https://github.com/Hantu-Raya/Nativune/releases/tag/v0.1.29) at the time of writing (unsigned installer); see [all releases](https://github.com/Hantu-Raya/Nativune/releases) |
...
pwsh -NoProfile -File scripts/build-release.ps1 -Version 0.1.29 -Configuration Release
```
