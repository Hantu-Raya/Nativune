...
| License | [MIT](LICENSE) |
| Latest release | [v0.1.24](https://github.com/Hantu-Raya/Nativune/releases/tag/v0.1.24) at the time of writing (unsigned installer); see [all releases](https://github.com/Hantu-Raya/Nativune/releases) |
...
pwsh -NoProfile -File scripts/build-release.ps1 -Version 0.1.24 -Configuration Release
```
