...
| License | [MIT](LICENSE) |
| Latest release | [v0.1.10](https://github.com/Hantu-Raya/Nativune/releases/tag/v0.1.10) at the time of writing (unsigned installer); see [all releases](https://github.com/Hantu-Raya/Nativune/releases) |
