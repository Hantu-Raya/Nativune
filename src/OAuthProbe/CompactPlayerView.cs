...
public sealed partial class CompactPlayerView : UserControl, IDisposable
{
    ...
    private void LayoutControls()
    {
        ...
        var height = Math.Max(LogicalMinimumHeight, ActualHeight > 0 ? ActualHeight : LogicalMinimumHeight);
        var horizontalExtra = Math.Max(0, width - LogicalMinimumWidth);
        var utilityShift = horizontalExtra;
        var seekY = Math.Max(130, height - 50);
        ...
        SetBounds(_remaining, 152, seekY, 44, 24);
        SetBounds(_seek, 204, seekY, Math.Max(80, 524 + horizontalExtra), 24);
        SetBounds(_duration, 736 + horizontalExtra, seekY, 48, 24);
    }
