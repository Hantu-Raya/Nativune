...
internal sealed class NativeFixtureWindow : Window
{
        ...
        string? fatalFailure)
    {
        ...
        var output = new
        {
            ...
            fixture = "src/Nativune/NativeFixture.cs",
            preservedSource = "src/Nativune/CompactPlayerView.cs;src/Nativune/SettingsDialog.cs;src/Nativune/ShellTheme.cs;src/Nativune/ShellSettings.cs;src/Nativune/ShortcutBindings.cs;src/Nativune/NativeIconCache.cs",
